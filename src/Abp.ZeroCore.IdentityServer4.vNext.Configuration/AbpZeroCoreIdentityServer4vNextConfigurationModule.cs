...
namespace Abp.IdentityServer4vNext
{
    ...
    public class AbpZeroCoreIdentityServer4vNextConfigurationModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpAutoMapper().Configurators.Add(config =>
            {
                ...
                config.CreateMap<Entities.ApiScope, ApiScope>(MemberList.Destination)
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AbpZeroCoreIdentityServer4vNextConfigurationModule).GetAssembly());
        }
    }
}