...
namespace Abp.IdentityServer4vNext.Services
{
    /// <summary>
    ...
    {
        private readonly IRepository<Client, int> _repository;
        ...
        public CorsPolicyService(IRepository<Client, int> repository,
